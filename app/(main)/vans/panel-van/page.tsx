...
export default async function PanelVanCategoryPage() {
  ...
  const relatedBlog = matchBlogPosts(getBlogIndex(), ["transit", "sprinter", "transporter", "vivaro", "crafter", "berlingo", "dispatch", "expert", "ducato", "master", "kangoo"], undefined, 3);
            ...
            <div className="rounded-[var(--radius-xl)] border border-border bg-white p-5">
              <RelatedLinks
                ...
                links={[
                  ...
                  { href: "/vans/electric", label: "Electric panel vans" },
                ]}
                variant="pills"
              />
            </div>

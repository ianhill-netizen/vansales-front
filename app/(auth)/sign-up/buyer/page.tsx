  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-6 text-center">
        ...
        <h1 className="mt-3 font-display text-[var(--text-xl)] font-extrabold text-ink-900">Create buyer account</h1>
      ...
      <div className="overflow-hidden rounded-[var(--radius-xl)] border border-border bg-white shadow-[var(--shadow-md)]">
        <form onSubmit={handleSubmit} className="space-y-4 px-6 py-6">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="first" className="block text-[var(--text-xs)] font-semibold uppercase tracking-widest text-ink-500">First name</label>
              <input id="first" name="first" type="text" required autoComplete="given-name"
            ...
            <div>
              <label htmlFor="last" className="block text-[var(--text-xs)] font-semibold uppercase tracking-widest text-ink-500">Last name</label>
              <input id="last" name="last" type="text" required autoComplete="family-name"
                className="mt-1 h-10 w-full rounded-[var(--radius-md)] border border-border bg-surface-0 px-3 text-[var(--text-sm)] outline-none focus-visible:border-brand-500" />
            </div>
          </div>
          <div>
          ...
          <button type="submit"
            className="flex h-11 w-full items-center justify-center rounded-[var(--radius-md)] bg-brand-500 text-[var(--text-sm)] font-bold text-white transition-colors hover:bg-brand-600">
            Create account →
          </button>
          <div className="relative flex items-center gap-3">
            <div className="h-px flex-1 bg-border" /><span className="text-[var(--text-xs)] text-ink-400">or</span><div className="h-px flex-1 bg-border" />
          </div>
          <button type="button" onClick={() => { setPersona("buyer"); router.push("/account"); }}

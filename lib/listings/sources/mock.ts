...
const SEEDS: Seed[] = [
  ...
  },
  {
    ...
    lng: -0.0922,
    description:
      "Private sale, no VAT. Short-wheelbase Custom with twin side doors and a decent service history. I'm retiring from the trade after 20 years so selling everything. Sensible offers only — no swaps.",
    features: ["Twin side doors", "Bluetooth", "Cruise control", "Bulkhead", "Parking sensors"],
    seller: { name: "Mark (private seller)", rating: null },
  ...
  },
  {
    ...
    make: "Vauxhall",
    model: "Vivaro",
    derivative: "2900 Edition L1 Diesel 120",
    year: 2019,
    plate: "69",
    price: 10995,
    seller_type: "private",
    ...
    lng: -3.1883,
    description:
      "Honest private sale. Used daily for local deliveries for the last four years. Bodywork shows its age on the sills but runs and drives well with a fresh MOT. Price is firm — no time-wasters.",
    features: ["Bluetooth", "Bulkhead", "Air conditioning", "Rear parking sensors"],
    seller: { name: "Sarah (private seller)", rating: null },
    published_at: "2026-06-17T14:30:00.000Z",
